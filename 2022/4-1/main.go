...
func main() {
	...
	for fileScanner.Scan() {
		...
		if firstNumberFirstSection <= firstNumberSecondSection && lastNumberFirstSection >= lastNumberSecondSection {
			count++
		} else if firstNumberSecondSection <= firstNumberFirstSection && lastNumberSecondSection >= lastNumberFirstSection {
			count++
		}
	}
	fmt.Println(count)
